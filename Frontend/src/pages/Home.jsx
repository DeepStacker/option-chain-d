...
const Home = () => {
  ...
  const tradingFeatures = [
    {
      ...
      description: "Advanced options chain analysis with live Greeks, volatility surfaces, and institutional-grade risk metrics for informed trading decisions.",
      benefits: ["Live Market Data", "Greeks Calculation", "Volatility Analysis", "Risk Assessment"],
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: BoltIcon,
      title: "Algorithmic Trading Engine",
      description: "Sophisticated trading algorithms with backtesting capabilities, strategy optimization, and automated execution for Indian markets.[1]",
      benefits: ["Strategy Backtesting", "Performance Analytics", "Auto Execution", "Risk Controls"],
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: ShieldCheckIcon,
      title: "Risk Management Suite",
      description: "Comprehensive portfolio risk analysis with stress testing, VaR calculations, and real-time position monitoring.",
      benefits: ["Portfolio Analysis", "Stress Testing", "VaR Calculation", "Position Monitoring"],
      color: "from-green-500 to-emerald-500"
    }
  ];

  const performanceStats = [
    { number: "₹50Cr+", label: "Daily Trading Volume", icon: CurrencyDollarIcon },
  ...
  const testimonials = [
    {
      ...
      content: "TradePro has transformed our options trading operations. The real-time analytics and risk management tools are unparalleled in the Indian market.",
      rating: 5,
    ...
    },
    {
      ...
      content: "The algorithmic trading capabilities and backtesting features have significantly improved our strategy performance and risk-adjusted returns.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Best options trading platform for institutional use. The data accuracy, speed, and analytical depth are exactly what we need for our strategies.",
      rating: 5,
  ...
  return (
    <div className={`${theme === 'dark' ? 'bg-gray-900' : 'bg-white'} overflow-hidden`}>
      {/* Hero Section */}
        ...
        >
          ...
          >
            <div className={`inline-flex items-center px-6 py-3 rounded-full border mb-8 ${
              ...
              <span className="font-semibold">Trusted by 500+ Professional Traders</span>
            </div>
          </motion.div>
          ...
          >
            Advanced options analytics, risk management, and algorithmic trading solutions 
            designed for professional traders and institutional clients in Indian markets.
          </motion.p>
          ...
          >
            <Link to="/option-chain">
              <motion.button
                whileHover={{ scale: 1.05, boxShadow: "0 25px 35px -5px rgba(0, 0, 0, 0.15)" }}
                whileTap={{ scale: 0.95 }}
      ...
      <section className={`py-24 ${
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Comprehensive suite of tools designed for serious options traders and institutional clients
            </motion.p>
          </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-8 bg-gradient-to-br ${feature.color} shadow-lg`}>
                      <Icon className="w-8 h-8 text-white" />
                    </div>
      ...
      <section className={`py-24 ${
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            >
              Join hundreds of professional traders and institutions who trust TradePro 
              for their options trading and risk management needs
            </motion.p>
            <motion.div
              variants={itemVariants}
