        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {indices.map((index, i) => (
            <motion.div
              ...
              className={`relative overflow-hidden p-5 rounded-2xl border cursor-pointer transition-all duration-300 hover:scale-[1.02] ${
                isDark 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((feature, i) => (
              <motion.button
                ...
                className={`group relative overflow-hidden p-5 rounded-2xl border text-left transition-all duration-300 hover:scale-[1.03] hover:shadow-xl ${feature.glow} ${
                  isDark 
